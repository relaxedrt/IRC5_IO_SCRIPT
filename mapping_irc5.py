...
for i in range(1, int(entradas_deseadas) + 1):
    ...
    file.write('      -Name "' + str(nombre_variable.value) + '" -SignalType "' + str(tipo_variable.value) +'" -Device "' + str(unidad_variable.value) + '" -Label "' + str(coment.value) + '"' +' -DeviceMap "' + str(devicemap.value) + '"' + os.linesep)
for n in range(1, int(salidas_deseadas) + 1):
    ...
    file.write('      -Name "' + str(nombre_variable.value) + '" -SignalType "' + str(tipo_variable.value) +'" -Device "' + str(unidad_variable.value) + '" -Label "' + str(coment.value) + '"' +' -DeviceMap "' + str(devicemap.value) + '"' + os.linesep)
print("Suerte con ello y aupa gimnastica.")